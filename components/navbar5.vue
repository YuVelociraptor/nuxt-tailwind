...
<template>
  <div class="bg-gray-800 text-white">
    <!-- ナビゲーションバー -->
    <nav class="flex items-center p-4 lg:justify-start">
      <!-- ハンバーガーボタン（左側） -->
      <button
          class="block lg:hidden p-2 mr-4"
          @click="toggleMenu"
      ...
      <!-- ロゴ -->
      <div class="flex-grow lg:flex-grow-0 flex justify-center lg:justify-start">
        <div class="text-xl font-bold">Logo</div>
      </div>

      <!-- メニュー項目（広い画面用） -->
      <ul class="hidden lg:flex space-x-4 ml-auto">
